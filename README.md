...
A simple lottery smart contract web application designed and tested using Remix, Mocha, and React. Users enter the lottery and a winner is (pseudo)randomly selected every round. Requires users to have Metamask installed.

Dapp front-end deployed at https://lottery12.herokuapp.com on the Rinkeby test network.

Lottery smart contract registered and verified at https://rinkeby.etherscan.io/address/0x77fdB0a8EcefE3787465271bf5678F19c0c889d2.
